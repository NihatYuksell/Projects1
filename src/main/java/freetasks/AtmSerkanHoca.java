...
public class AtmSerkanHoca {public static void main(String[] args) {
    ...
    if (isPasswordInvalid(lowerNewpwd, name, surname)) {
    ...
    private static boolean isPasswordInvalid(String password, String name, String surname) {
        String[] allNames = (name + " " + surname).toLowerCase().split(" ");
        for (String part : allNames) {
